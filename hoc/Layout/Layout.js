...
class Layout extends Component {
  ...
  componentDidMount() {
    // console.log('this.props.pageData', JSON.stringify(this.props));
    ...
    userChannel.onmessage = data => {
      if (data.payload.type === 'LOGIN') {
        if (
          ...
          this.props.pageData.loggedInUserDetails.user_id !=
            this.props.pageInfoData.loggedInUserDetails.user_id
        ) {
          Router.push(
            this.state.previousUrl ? this.state.previousUrl : Router.asPath,
          );
        }
  ...
  render() {
    ...
    if (
      ...
      this.props.pageInfoData.video.completed == 1
    ) {
      ...
      if (this.props.pageInfoData.video.type == 3) {
        ...
        this.props.pageInfoData.video.type == 10 &&
        this.props.pageInfoData.video.is_livestreaming == 0 &&
        this.props.pageInfoData.liveStreamingURL
      ) {
        videoURL =
          this.props.pageInfoData.liveStreamingURL +
          '/' +
          this.props.pageInfoData.video.code;
    ...
    let CDN_URL_FOR_STATIC_RESOURCES = this.props.pageInfoData
      .CDN_URL_FOR_STATIC_RESOURCES
      ? this.props.pageInfoData.CDN_URL_FOR_STATIC_RESOURCES
      : '';
    let fixedMenu = '';
    if (this.state.width > 992)
      fixedMenu =
        (this.props.hideSmallMenu ? ' top-menu' : ' sidemenu') +
        disableMarginLeftClass +
        (this.props.menuOpen ? '' : ' sidemenu-opened');
    return (
      <React.Fragment>
        {generalInfo ? (
          <Head>
            ...
            {generalInfo.description ? (
              <meta
                name="description"
                content={Translate(this.props, generalInfo.description)}
              />
            ) : null}
            ...
            {generalInfo.title ? (
              <meta
                property="og:title"
                content={Translate(this.props, generalInfo.title)}
              />
            ) : null}
            {generalInfo.description ? (
              <meta
            ...
            {generalInfo.image ? (
              <meta
                property="og:image"
                content={(!isURL ? imageSuffix : '') + generalInfo.image}
              />
            ) : null}
            {generalInfo.image && generalInfo.imageWidth ? (
              <meta
                property="og:image:width"
                content={generalInfo.imageWidth}
              />
            ) : null}
            {generalInfo.image && generalInfo.imageHeight ? (
              <meta
                property="og:image:height"
                content={generalInfo.imageHeight}
              />
            ) : null}
            {generalInfo.title ? (
              <meta
            ...
            {this.props.pageInfoData.appSettings['pwa_app_name'] ? (
              <React.Fragment>
                ...
                <meta
                  ...
                  content={this.props.pageInfoData.appSettings['pwa_app_name']}
                />
                <meta
                  name="msapplication-TileColor"
                  content={
                    this.props.pageInfoData.appSettings['pwa_app_bg_color']
                  }
                />
                <meta
                  name="theme-color"
                  content={
                    this.props.pageInfoData.appSettings['pwa_app_theme_color']
                  }
                />
                <meta
                  ...
                  content={
                    imageSuffix +
                    this.props.pageInfoData.appSettings['pwa_icon_sizes_512']
                  }
                />
                ...
                <link
                  href={
                    imageSuffix +
                    this.props.pageInfoData.appSettings['pwa_icon_sizes_192']
                  }
                  rel="icon"
                  sizes="192x192"
                />
                ...
                <link
                  href={
                    imageSuffix +
                    this.props.pageInfoData.appSettings['pwa_icon_sizes_152']
                  }
                  rel="apple-touch-icon"
                  sizes="152x152"
                />
                <link
                  href={
                    imageSuffix +
                    this.props.pageInfoData.appSettings['pwa_icon_sizes_144']
                  }
                  rel="apple-touch-icon"
                  sizes="144x144"
                />
                ...
                <link
                  href={
                    imageSuffix +
                    this.props.pageInfoData.appSettings['pwa_icon_sizes_128']
                  }
                  rel="apple-touch-icon-precomposed"
                  sizes="128x128"
                />
                ...
                <link
                  href={
                    imageSuffix +
                    this.props.pageInfoData.appSettings['pwa_icon_sizes_72']
                  }
                  rel="apple-touch-icon"
                  sizes="72x72"
                />
            ...
            {generalInfo.custom_tags
              ? require('html-react-parser')(generalInfo.custom_tags)
              : null}
          </Head>
        ) : null}
        ...
        <Head>
          <link
            ...
            href={
              ...
              this.props.pageInfoData.appSettings['favicon']
            }
          />
          <link
            href={`${CDN_URL_FOR_STATIC_RESOURCES}/static/css/variable_white.css`}
            rel="stylesheet"
          />
          {this.getSelectedLanguage() ? (
            <React.Fragment>
              <link
                href={`${CDN_URL_FOR_STATIC_RESOURCES}/static/css/bootsrap-rtl.min.css`}
                rel="stylesheet"
              />
              <link
                href={`${CDN_URL_FOR_STATIC_RESOURCES}/static/css/rtl.style.css`}
                rel="stylesheet"
              />
            </React.Fragment>
          ) : null}
        ...
        {theme == 'dark' ? (
          <Head>
            <link
              href={`${CDN_URL_FOR_STATIC_RESOURCES}/static/css/variable_dark.css`}
              rel="stylesheet"
            />
          </Head>
        ) : null}
        {this.props.videoView &&
        this.props.pageInfoData.video &&
        this.props.pageInfoData.video.type == 3 ? (
          <Head>
        ...
        this.props.pageInfoData.photos &&
        this.props.pageInfoData.photos.results.length > 0 ? (
          <Head>
            <link
              href={`${CDN_URL_FOR_STATIC_RESOURCES}/static/css/magnific-popup.css`}
              rel="stylesheet"
            />
            <script
              src={`${CDN_URL_FOR_STATIC_RESOURCES}/static/scripts/jQuery-1.9.1.js`}
            ></script>
            <script
              src={`${CDN_URL_FOR_STATIC_RESOURCES}/static/scripts/jquery.magnific-popup.js`}
            ></script>
          </Head>
        ) : null}
        ...
        {isIE ? <UnsupportedBrowser {...this.props} /> : null}
        {/*{*/}
        ...
        !isIE &&
        !this.props.pageInfoData.maintanance &&
        !this.props.embedVideo ? (
          <React.Fragment>
            <Header
              {...this.props}
              layout={this.state.width > 992 ? '' : 'mobile'}
              layoutWidth={this.state.width}
            />
            {this.props.pageInfoData.appSettings['below_header'] ? (
              <AdsIndex
                className="header_advertisement"
                paddingTop="90px"
                ads={this.props.pageInfoData.appSettings['below_header']}
              />
            ) : null}
          </React.Fragment>
        ) : null}
        ...
        {!isIE && this.props.embedVideo ? (
          <WithErrorHandler {...this.props}>
            <div className="embed-content-wrap">{this.props.children}</div>
          </WithErrorHandler>
        ) : null}
        {!isIE && !this.props.embedVideo ? (
          !this.props.liveStreaming ? (
            <WithErrorHandler {...this.props}>
              <div
                className={`main-content${fixedMenu}${this.props.pageInfoData.loggedInUserDetails ? ' user-logged-in' + fixedHeader : fixedHeader}${this.state.width > 992 ? '' : ' mobile-layout-cnt'}${this.props.pageInfoData.slideshow ? ' slideshow-enable' : ''}`}
              >
                {this.state.width > 992 ? (
                  <React.Fragment>
                    <div
                ...
                <div
                  className={`content-wrap${this.props.menuOpen && !this.props.hideSmallMenu && this.state.width > 992 ? ' ml100' : this.props.menuOpen && this.props.hideSmallMenu && this.state.width > 992 ? ' ml0' : ''}${this.state.width > 992 ? '' : ' mobile-layout'}`}
                >
                  {this.props.children}
                </div>
              </div>
            ...
            <WithErrorHandler {...this.props}>
              <div
                className={`ls_contentWrap${this.state.width > 992 ? '' : ' mobile-layout-cnt'}`}
              >
                <div className="ls_mainContent">{this.props.children}</div>
              </div>
            </WithErrorHandler>
          )
        ) : null}
          ...
          <React.Fragment>
            {this.props.pageInfoData.appSettings['above_footer'] ? (
              <AdsIndex
                ...
                paddingTop="20px"
                ads={this.props.pageInfoData.appSettings['above_footer']}
              />
            ) : null}
            <Footer
              {...this.props}
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    updateAudioData: (audios, song_id) =>
      dispatch(actions.updateAudioData(audios, song_id)),
  };
};
