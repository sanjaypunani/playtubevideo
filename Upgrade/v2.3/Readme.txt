PlayTubeVideo v2.3 Upgrade Documentation

Note: This update is just for who is using 2.2, if you're still using older verisons, Please Upgrade the script version by version.
