PlayTubeVideo v1.0.1 Upgrade Documentation

Note: This update is just for who is using 1.0, if you're still using older verisons, Please Upgrade the script version by version.
