...
const VideoSlider = asyncComponent(() => {
  return import('../HomePage/VideoSlider');
});
import actions from '../../store/actions/general';
const Members = asyncComponent(() => {
  return import('../HomePage/Members');
});
const Audio = asyncComponent(() => {
  return import('../HomePage/Audio');
});
const Slideshow = asyncComponent(() => {
  return import('../../components/Slideshow/Index');
});
...
class Home extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      categoriesData: props.pageInfoData.categoryVideos,
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (nextProps.pageInfoData.categoryVideos != prevState.categories) {
      dataTypes.categoriesData = nextProps.pageInfoData.categoryVideos;
    }
    ...
    return (
      <React.Fragment>
        ...
        {!this.state.slideshow ? (
          ...
          <React.Fragment>
            <TopVideos
              ...
              seemore={true}
              title={Translate(this.props, 'Featured Videos')}
              videos={this.state.videos.sponsored}
              type="featured"
            />
          </React.Fragment>
        ) : null}
        {this.state.videos.featured ? (
          this.props.pageInfoData.appSettings['featuredvideo_ads'] ? (
            <AdsIndex
              ...
              ads={this.props.pageInfoData.appSettings['featuredvideo_ads']}
            />
          ) : null
        ) : null}
        {this.state.videos && this.state.videos.sponsored ? (
          <React.Fragment>
            <TopVideos
              ...
              seemore={true}
              title={Translate(this.props, 'Sponsored Videos')}
              videos={this.state.videos.sponsored}
              type="sponsored"
            />
            {this.props.pageInfoData.appSettings['sponsoredvideo_ads'] ? (
              <AdsIndex
                ...
                ads={this.props.pageInfoData.appSettings['sponsoredvideo_ads']}
              />
            ) : null}
          </React.Fragment>
        ) : null}
        {this.state.videos && this.state.videos.hot ? (
          <React.Fragment>
            ...
            <TopVideos
              ...
              seemore={true}
              title={Translate(this.props, 'Hot Videos')}
              type="hot"
              videos={this.state.videos.hot}
            />
            {this.props.pageInfoData.appSettings['hotvideo_ads'] ? (
              <AdsIndex
                paddingTop="20px"
                className="hotvideo_ads"
                ads={this.props.pageInfoData.appSettings['hotvideo_ads']}
              />
            ) : null}
          </React.Fragment>
        ) : null}
        {this.state.videos && this.state.videos.recent_videos ? (
          <React.Fragment>
            {this.state.videos &&
            (this.state.videos.sponsored || this.state.videos.hot) ? (
              <div className="container hr">
                <div className="row">
                  <div className="col-sm-12">
                    <hr className="horline" />
            ...
            <TopVideos
              ...
              seemore={true}
              title={Translate(this.props, 'Recent Videos')}
              sort="recent"
              videos={this.state.videos.recent_videos}
            />
            {this.props.pageInfoData.appSettings['recentvideo_ads'] ? (
              <AdsIndex
                paddingTop="20px"
                className="recentvideo_ads"
                ads={this.props.pageInfoData.appSettings['recentvideo_ads']}
              />
            ) : null}
          </React.Fragment>
        ) : null}
          ...
          <React.Fragment>
            ...
            <div className="container">
              <Members
                ...
                seemore={true}
                titleHeading={Translate(
                  this.props,
                  'Best Livestreamer Of The Month',
                )}
                sort="recent"
                type="member"
                members={this.state.livestreamers}
              />
            </div>
          </React.Fragment>
        ) : null}
          ...
          <React.Fragment>
            ...
            <div className="container">
              <Members
                ...
                seemore={true}
                titleHeading={Translate(this.props, 'Popular Members')}
                sort="recent"
                type="member"
        ...
        {this.state.channels && this.state.channels.featured ? (
          <React.Fragment>
            ...
            <Channels
              ...
              seemore={true}
              title={Translate(this.props, 'Featured Channels')}
              channels={this.state.channels.featured}
              type="featured"
            />
            {this.props.pageInfoData.appSettings['featuredchannel_ads'] ? (
              <AdsIndex
                ...
                paddingTop="20px"
                ads={this.props.pageInfoData.appSettings['featuredchannel_ads']}
              />
            ) : null}
          </React.Fragment>
        ) : null}
        {this.state.channels && this.state.channels.sponsored ? (
          <React.Fragment>
            ...
            <Channels
              ...
              seemore={true}
              title={Translate(this.props, 'Sponsored Channels')}
              channels={this.state.channels.sponsored}
              type="sponsored"
            />
        ...
        {this.state.channels && this.state.channels.hot ? (
          <React.Fragment>
            ...
            <Channels
              ...
              seemore={true}
              title={Translate(this.props, 'Hot Channels')}
              type="hot"
              channels={this.state.channels.hot}
            />
            {this.props.pageInfoData.appSettings['hotchannel_ads'] ? (
              <AdsIndex
                paddingTop="20px"
                className="hotchannel_ads"
                ads={this.props.pageInfoData.appSettings['hotchannel_ads']}
              />
            ) : null}
          </React.Fragment>
        ) : null}
        {this.state.audio && this.state.audio ? (
          <React.Fragment>
            ...
            <Audio
              ...
              seemore={true}
              title={Translate(this.props, 'Recent Audio')}
              type="latest"
          ...
          ? this.state.categories.map(cat => {
              return (
                <React.Fragment key={cat.category.category_id + '_cnt'}>
                  ...
                  <TopVideos
                    key={cat.category.category_id + '_cat_videos'}
                    {...this.props}
                    openPlaylist={this.props.openPlaylist}
                    headerTitle={
                    ...
                    videos={cat.videos}
                    title={Translate(this.props, cat.category.title)}
        ...
        {this.state.categories ? (
          this.props.pageInfoData.appSettings['categoryvideo_ads'] ? (
            <AdsIndex
              ...
              ads={this.props.pageInfoData.appSettings['categoryvideo_ads']}
            />
          ) : null
        ) : null}
...
const mapDispatchToProps = dispatch => {
  return {
    openPlaylist: (open, video_id) =>
      dispatch(actions.openPlaylist(open, video_id)),
  };
};
