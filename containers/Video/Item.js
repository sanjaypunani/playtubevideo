...
class Item extends React.Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (prevState.localUpdate) {
      ...
      prevState.video != nextProps.video ||
      prevState.hover != nextProps.hover
    ) {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (
      ...
      this.state.hover != nextProps.hover ||
      this.state.analytics != nextState.analytics
    ) {
      return true;
    }
    return false;
  ...
  deleteVideo = e => {
    e.preventDefault();
    let message = !this.props.contentType
      ? Translate(
          this.props,
  ...
  hoverOn = () => {
    if (
      ...
      !this.props.canEdit &&
      this.width > 992 &&
      this.props.pageInfoData.appSettings['video_preview'] == 1 &&
      this.state.video.is_livestreaming != '1'
    ) {
      if (
        !this.state.video.password &&
        (!this.state.video.adult ||
          (this.state.video.adult && this.props.pageInfoData.adultAllowed))
      )
  ...
  render() {
            ...
            <div className="comments">
              <div className="VideoDetails-commentWrap">
                <div className="popup_wrapper_cnt_header">
                  ...
                  <a onClick={this.closePopup} className="_close">
                    <i></i>
                  </a>
                </div>
                <Analytics
    ...
    if (
      ...
      this.state.video.mediaserver_stream_id &&
      this.state.video.image &&
      this.state.video.image.indexOf('LiveApp/previews') > -1
    ) {
    ...
    return (
      <React.Fragment>
        ...
        <div className="ptv_videoList_wrap">
          ...
          >
            <Link
              href={`/${this.props.ip_language}/watch`}
              onClick={this.props.closePopUp}
              customParam={`videoId=${this.state.video.custom_url}${customParams}`}
              as={`/${this.props.ip_language}/watch/${this.state.video.custom_url}${stringId}`}
            >
              <a>
            ...
            <div className="btnBoxHover">
              ...
              {this.props.pageInfoData.appSettings['videos_playlist'] == 1 &&
              this.props.pageInfoData.appSettings['enable_playlist'] == 1 &&
              (!this.props.pageInfoData.levelPermissions ||
                this.props.pageInfoData.levelPermissions['playlist.create'] ==
                  1) &&
              !playlist_id ? (
                <a
                  className="playlist"
                  title={Translate(this.props, 'Save to playlist')}
            ...
            <div className="labelBtn">
              {this.props.pageInfoData.appSettings['videos_featuredlabel'] ==
                1 &&
              this.props.pageInfoData.appSettings['video_featured'] == 1 &&
              this.state.video.is_featured == 1 ? (
                <span
                  className="lbl-Featured"
                  title={Translate(this.props, 'Featured Video')}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
              ...
              {this.props.pageInfoData.appSettings['videos_sponsoredLabel'] ==
                1 &&
              this.props.pageInfoData.appSettings['video_sponsored'] == 1 &&
              this.state.video.is_sponsored == 1 ? (
                <span
                  className="lbl-Sponsored"
                  title={Translate(this.props, 'Sponsored Video')}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
              ...
              {this.props.pageInfoData.appSettings['videos_hotLabel'] == 1 &&
              this.props.pageInfoData.appSettings['video_hot'] == 1 &&
              this.state.video.is_hot == 1 ? (
                <span
                  className="lbl-Hot"
                  title={Translate(this.props, 'Hot Video')}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
          ...
          <div className="videoList_content">
              ...
              this.props.pageInfoData.appSettings['videos_share'] == 1 ? (
                <div className="dropdown TitleRightDropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-right edit-options">
                      ...
                      <li>
                        ...
                        >
                          <a
                            ...
                            title={Translate(this.props, 'Edit')}
                          >
                    ...
                    {this.props.canDelete ? (
                      <li>
                        <a
                          ...
                          title={Translate(this.props, 'Delete')}
                          href="#"
                    ...
                    {this.props.canEdit ? (
                      <li>
                        <a
                          ...
                          title={Translate(this.props, 'Analytics')}
                        >
                    ...
                    {this.props.pageInfoData.appSettings['videos_share'] ==
                    1 ? (
                      <SocialShare
                        {...this.props}
                        buttonHeightWidth="30"
                        tags={this.state.video.tags}
                        url={`/${this.props.ip_language}/watch/${this.state.video.custom_url}`}
                        title={renderToString(
                          <CensorWord
                            {...this.props}
                            text={this.state.video.title}
                    ...
                    {this.props.pageInfoData.appSettings['videos_playlist'] ==
                      1 &&
                    this.props.pageInfoData.appSettings['enable_playlist'] ==
                      1 &&
                    (!this.props.pageInfoData.levelPermissions ||
                      this.props.pageInfoData.levelPermissions[
                        'playlist.create'
            ...
            <div className="videoInfo">
              ...
              <span className="videoViewDate">
                ...
                {this.props.pageInfoData.appSettings['videos_views'] == '1' &&
                this.props.pageInfoData.appSettings['videos_datetime'] ==
                  '1' ? (
            ...
            this.state.video.channel_name ? (
              <div className="videoInfo">
                <span className="videoViewDate">
                  <span>
                    {`${ShortNumber(
                      this.state.video.total_viewer
                        ? this.state.video.total_viewer
                        : 0,
                    )}`}{' '}
                    {this.props.t('viewer_watching_count', {
                      count: this.state.video.total_viewer
                        ? this.state.video.total_viewer
                        : 0,
                    })}
                  </span>
            ...
            <div className="LikeDislikeWrap">
              <ul className="LikeDislikeList">
                ...
                {this.props.pageInfoData.appSettings['videos_dislike'] == 1 ? (
                  <li>
                    <Dislike
                      icon={true}
                      {...this.props}
                      dislike_count={this.state.video.dislike_count}
                      item={this.state.video}
                      type="video"
                      id={this.state.video.video_id}
                    />
                ...
                {this.props.pageInfoData.appSettings['videos_favourite'] ==
                1 ? (
                  <li>
                    <Favourite
                      icon={true}
                      {...this.props}
                      favourite_count={this.state.video.favourite_count}
                      item={this.state.video}
                      type="video"
                      id={this.state.video.video_id}
                    />
