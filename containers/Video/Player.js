...
class Player extends Component {
    ...
    initiatePlayer = () => {
        ...
        if (this.state.video.type == 3) {
            ...
            let plrsuffix = "https://storage1.inqtube.com/gnxPlayer/public/gplr2.html"
    ...
    render() {
        ...
        if (this.state.purchased && !this.props.miniplayer) {
            htmlPrice = <div className="purchase_video_content video_purchase"
                ...
                <h5>
                    ...
                    <button className="btn btn-main"
                            onClick={this.purchaseClicked}>{Translate(this.props, 'Purchase ') + " " + ReactDOMServer.renderToStaticMarkup(
                        <Currency {...this.props} {...userBalance} />)} </button>
                </h5>
            </div>
        }
        ...
        return (
            <div key={key}>
                <div data-vjs-player className="video_player_cnt player-wrapper"
                     style={{width: "100%", position: "relative"}}>
                    {
                        this.state.video.status == 1 ?
                            <React.Fragment>
                                {
                                    this.state.video.sell_videos && this.state.video.price > 0 && !this.state.video.videoPurchased && !this.props.miniplayer ?
                                        <button className="video_purchase_btn"
                                                onClick={this.purchaseClicked}>{Translate(this.props, 'Purchase ') + " " + ReactDOMServer.renderToStaticMarkup(
                                            <Currency {...this.props} {...userBalance} />)} </button>
                                        : null
                                }
                                ...
                                <iframe
                                    ...
                                    style={{ width: "100%", "height": this.props.height ? this.props.height : "100%", position: "relative", border:'none' }}
                            ...
                            :
                            <div className="purchase_video_content video_processing_cnt"
                                 style={{width: "100%", "height": this.props.height ? this.props.height : "100%"}}>
                                {
