...
class Player extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (prevState.localUpdate) {
      ...
      nextProps.video != prevState.video ||
      prevState.currentVideoTime != nextProps.currentVideoTime
    ) {
      if (typeof nextProps.getHeight == 'function') nextProps.getHeight();
      return {
        video: nextProps.video,
        currentVideoTime: nextProps.currentVideoTime,
        purchased: false,
      };
    } else {
      return null;
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      this.props.video != prevState.video ||
      prevState.currentVideoTime != this.props.currentVideoTime
    ) {
      this.setup();
    }
  }
  ...
  handleEnded = () => {
    if (
      this.state.video.sell_videos &&
      this.state.video.price > 0 &&
      !this.state.video.videoPurchased
    ) {
  ...
  initiatePlayer = () => {
    ...
    if (this.state.video.type == 3) {
      ...
      let plrsuffix =
        'https://storage1.inqtube.com/gnxPlayer/public/gplr2.html';
      ...
      suffix = 'https://storage1.inqtube.com/storage/';
      // let path = "/upload/videos/video/"
      let path = '';
      console.log(
        'proper video url is ',
        path +
          this.state.video.custom_url +
          '/' +
          this.state.video.custom_url +
          '.m3u8',
      );
      ...
      videoJsOptions = {
        autoplay: true,
        muted:
          typeof this.props.muted != 'undefined' ? this.props.muted : false,
        controls:
          typeof this.props.showControls != 'undefined'
  ...
  render() {
    // window.plstate = this.state;
    // window.plprops=this.props;
      ...
      htmlPrice = (
        ...
        >
          ...
          <h5>
            ...
            <br />
            <br />
            <button className="btn btn-main" onClick={this.purchaseClicked}>
              {Translate(this.props, 'Purchase ') +
                ' ' +
                ReactDOMServer.renderToStaticMarkup(
                  <Currency {...this.props} {...userBalance} />,
                )}{' '}
            </button>
          </h5>
        </div>
          ...
          {this.state.video.status == 1 ? (
            <React.Fragment>
              ...
              {this.state.video.watermark ? (
                <div className="watermarkLogo">
                  <a
                    href={config.app_server}
                    {...this.props.watermarkLogoParams}
                  >
                    <img
                      src={this.props.imageSuffix + this.state.video.watermark}
                    />
                  </a>
                </div>
              ) : null}
              ...
              <iframe
                ...
                // src="https://gnxplayer.indiaott.com/?vod=6047ec1f9b74d96128582a53&amp;autoplay=true"
                // src="https://gnxplayer.indiaott.com/gplr2.html?path=http://localhost:3000/upload/videos/video/vaiakmo1iicw/vaiakmo1iicw.m3u8&autoplay=true"
            ...
            >
              {this.state.video.status == 2 ? (
                ...
                <h5>
                  {this.props.t(
                    'Video failed processing, please upload new video.',
                  )}
                </h5>
              )}
            </div>
