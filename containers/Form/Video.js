  ...
  render() {
    ...
    if (this.state.has_parent === '1') {
      ...
      suggestionValue = [
        {
          title: 'title',
          image:
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmvPcqapt-6CbYBXm49td2AME43vsrxGpkdbF4zkbW&s',
          id: '123',
        },
      ];
      //   }
      formFields.push({
        ...
        setAutosuggestId: this.onChangeParentVideo,
