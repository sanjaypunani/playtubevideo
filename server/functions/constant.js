const general = {
  ...
  USERNOTVERIFIED:
    'You have not verified your Account yet, please check your email and verify it.',
...
const ads = {
  ...
  LIMITERRROR:
    'Your allowed upload limit reached, upgrade your subscription plan or delete old advertisement.',
};
const auth = {
  ...
  EMAILVERIFY:
    'This account still requires either email verification or admin approval.',
  ADMINAPPROVAL: 'This account still requires admin approval.',
  RESENDEMAILVERIFY:
    'Verification email sent successfully, please check your email and follow the instructions.',
};

const video = {
  LIMITERRROR:
    'Your allowed upload limit reached, upgrade your subscription plan or delete old videos.',
  SUCCESS: 'Video create successfully.',
  EDIT: 'Video edited successfully.',
  DELETED: 'Video deleted successfully',
  QUOTAREACHED:
    'You have reached your upload quota limit. Please delete your previous uploaded videos or upgrade your membership.',
  WITHDRAWREQERROR:
    'Withdraw request amount must be less than or equal to thresold amount',
  WITHDRAWREQDELETE: 'Withdraw request deleted successfully.',
  WITHDRAWREQPREVIOUSERROR:
    'Previous request does not process yet, so please wait.',
  liveStreaming:
    'You have reached your Live Streaming create limit. Please upgrade your membership.',
...
const movie = {
  LIMITERRROR:
    'Your allowed upload limit reached, upgrade your subscription plan or delete old movies.',
  SUCCESS: 'Movie create successfully.',
  EDIT: 'Movie edited successfully.',
  DELETED: 'Movie deleted successfully',
  QUOTAREACHED:
    'You have reached your upload quota limit. Please delete your previous uploaded movies or upgrade your membership.',
...
const channel = {
  ...
  VIDEONOTIFYEDADDED:
    'Videos Added to Channel successfully, it will appear once it finished processing.',
  SUCCESS: 'Channel created successfully.',
  DELETED: 'Channel deleted successfully',
  EDIT: 'Channel edited successfully.',
  QUOTAREACHED:
    'You have reached your upload quota limit. Please delete your previous uploaded channels or upgrade your membership.',
...
const member = {
  ...
  VERIFICATIONREQUESTALREADYSEND:
    'Verification Request already send, please wait for the request to complete.',
  ...
  MONETIZATIONREQUESTALREADYSEND:
    'Monetization Request already send, please wait for the request to complete.',
...
const playlist = {
  ...
  QUOTAREACHED:
    'You have reached your upload quota limit. Please delete your previous created playlist or upgrade your membership.',
};
const audio = {
  ...
  QUOTAREACHED:
    'You have reached your upload quota limit. Please delete your previous created audio or upgrade your membership.',
};
const blog = {
  ...
  QUOTAREACHED:
    'You have reached your upload quota limit. Please delete your previous created blogs or upgrade your membership.',
};
const error = {
...
const report = {
  SUCCESS:
    'Report submitted successfully, we will soon take appropriate action against the reported content.',
};
