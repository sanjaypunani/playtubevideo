...
exports.create = async (req, res) => {
    ...
    let catObj =req.query.categoriesVideo.filter((item)=>item.category_id===catId);
...
exports.executeFFMPEG = async (command, filePath, resolution, orgPath, FFMPEGpath, watermarkImage, req) => {
    ...
    console.log(" params ", command, filePath, resolution, orgPath, FFMPEGpath, watermarkImage)
    return false;
